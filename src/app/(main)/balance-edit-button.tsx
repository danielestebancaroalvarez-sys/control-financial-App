      ...
      {open && (
        <>
          ...
          <form
            ...
            className="absolute right-0 top-10 z-50 w-64 rounded-2xl bg-white text-cc-primary shadow-xl border border-[#EEEEEE] p-4 space-y-3"
          >
            <p className="text-[12px] font-bold text-cc-primary">Ajustar saldo</p>
