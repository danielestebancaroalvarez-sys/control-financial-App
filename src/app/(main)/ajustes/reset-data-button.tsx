...
import { resetHouseholdData } from '@/lib/household/actions'

const CONFIRM_TEXT = 'BORRAR'

export function ResetDataButton({ householdId }: { householdId: string }) {
  ...
  function handleReset() {
    ...
    startTransition(async () => {
      const result = await resetHouseholdData(householdId)
      if (result.error) {
