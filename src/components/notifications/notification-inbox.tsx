  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        type="button"
        onClick={handleOpen}
        className="relative w-10 h-10 rounded-full bg-white/80 border border-white/70 shadow-sm flex items-center justify-center text-[#636E72] hover:text-[#00BFA5] transition-colors"
      ...
      {open && (
        <div className="absolute right-0 top-12 z-50 w-[min(20rem,calc(100vw-2.5rem))] rounded-[20px] bg-white border border-[#EEEEEE] shadow-[0_12px_40px_rgba(0,0,0,0.12)] overflow-hidden">
